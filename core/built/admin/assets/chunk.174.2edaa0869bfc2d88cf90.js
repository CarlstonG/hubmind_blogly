...
e&&e.getTransaction()&&e.setSpan(void 0)}},43174:(t,e,n)=>{n.r(e),n.d(e,{BROWSER_TRACING_INTEGRATION_ID:()=>st,BrowserTracing:()=>ot,IdleTransaction:()=>G.io,Integrations:()=>i,Span:()=>dt.Dr,SpanStatus:()=>_t,TRACEPARENT_REGEXP:()=>D.K,Transaction:()=>pt.Y,addExtensionMethods:()=>a.ro,defaultRequestInstrumentationOptions:()=>nt,extractTraceparentData:()=>D.q,getActiveTransaction:()=>U.x1,hasTracingEnabled:()=>U.zu,instrumentOutgoingRequests:()=>it,spanStatusfromHttpCode:()=>dt.Zd,startIdleTransaction:()=>a.lb,stripUrlQueryAndFragment:()=>o.rt})
var i={}
...
n?(0,g.hl)(n.ApolloServerBase.prototype,"constructSchema",(function(t){return function(){var n=(0,b.lE)(this.config.resolvers)
...
var l=t.call(this,...d)
return(0,_.J8)(l)?l.then((t=>((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),t))):((0,s.x)([o,"optionalAccess",t=>t.finish,"call",t=>t()]),l)}}))}(t,n,i,e)}))})),t))),t.call(this)}})):r.kg.error("Apollo Integration was unable to require apollo-server-core package.")}}N.__initStatic()
var x=n(66627),D=n(75492),B=n(22850),k=n(68256),G=n(27448),U=n(48206),Y=(0,x.R)(),A=n(4549),I=n(88468),O=(t,e,n)=>{let i
return a=>{e.value>=0&&(a||n)&&(e.delta=e.value-(i||0),(e.delta||void 0===i)&&(i=e.value,t(e)))}},C=(t,e)=>({name:t,value:(0,A.h)(e,(()=>-1)),delta:0,entries:[],id:`v2-${Date.now()}-${Math.floor(8999999999999*Math.random())+1e12}`}),w=(t,e)=>{try{if(PerformanceObserver.supportedEntryTypes.includes(t)){if("first-input"===t&&!("PerformanceEventTiming"in self))return
var n=new PerformanceObserver((t=>t.getEntries().map(e)))
return n.observe({type:t,buffered:!0}),n}}catch(t){}},$=(t,e)=>{var n=i=>{"pagehide"!==i.type&&"hidden"!==(0,x.R)().document.visibilityState||(t(i),e&&(removeEventListener("visibilitychange",n,!0),removeEventListener("pagehide",n,!0)))}
addEventListener("visibilitychange",n,!0),addEventListener("pagehide",n,!0)}
let M=-1
var L=()=>(M<0&&(M="hidden"===(0,x.R)().document.visibilityState?0:1/0,$((t=>{let{timeStamp:e}=t
...
return n&&t.startTimestamp>n&&(t.startTimestamp=n),t.startChild({startTimestamp:n,...i})}var F=(0,x.R)()
function z(){return F&&F.addEventListener&&F.performance}let j,J,X=0,W={}
function Z(){((t,e)=>{var n=C("CLS",0)
let i,a=0,s=[]
...
c&&(i=O((t=>{var e=t.entries.pop()
e&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS"),W.cls={value:t.value,unit:""},J=e)}),n,void 0),$((()=>{c.takeRecords().map(o),i(!0)})))})()}function Q(t){((t,e)=>{var n=L(),i=C("LCP")
let a
var s=t=>{var e=t.startTime
e<n.firstHiddenTime&&(i.value=e,i.entries.push(t)),a&&a()},o=w("largest-contentful-paint",s)
if(o){a=O((t=>{var e=t.entries.pop()
...
var c=()=>{q[i.id]||(o.takeRecords().map(s),o.disconnect(),q[i.id]=!0,a(!0))};["keydown","click"].forEach((t=>{addEventListener(t,c,{once:!0,capture:!0})})),$(c,!0)}})(0,t)}function K(){((t,e)=>{var n=L(),i=C("FID")
let a
var s=t=>{a&&t.startTime<n.firstHiddenTime&&(i.value=t.processingStart-t.startTime,i.entries.push(t),a(!0))},o=w("first-input",s)
o&&(a=O((t=>{var e=t.entries.pop()
if(e){var n=(0,U.XL)(I.Z1),i=(0,U.XL)(e.startTime);("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FID"),W.fid={value:t.value,unit:"millisecond"},W["mark.fid"]={value:n+i,unit:"second"}}}),i,void 0),$((()=>{o.takeRecords().map(s),o.disconnect()}),!0))})()}function V(t,e,n,i,a,s){var r=s?e[s]:e[`${n}End`],o=e[`${n}Start`]
o&&r&&H(t,{op:"browser",description:(0,A.h)(a,(()=>n)),startTimestamp:i+(0,U.XL)(o),endTimestamp:i+(0,U.XL)(r)})}var tt=n(98902),et=n(8142),nt={traceFetch:!0,traceXHR:!0,tracingOrigins:["localhost",/^\//]}
...
var c={}
e&&(0,et.o)("fetch",(t=>{!function(t,e,n){if((0,U.zu)()&&t.fetchData&&e(t.fetchData.url))if(t.endTimestamp){var i=t.fetchData.__span
if(!i)return;(s=n[i])&&(t.response?s.setHttpStatus(t.response.status):t.error&&s.setStatus("internal_error"),s.finish(),delete n[i])}else{var a=(0,U.x1)()
...
if((0,_.V9)(t,Request)&&(a=t.headers),a)if("function"==typeof a.append)a.append("sentry-trace",n.toTraceparent()),a.append(B.bU,(0,B.J8)(e,a.get(B.bU)))
else if(Array.isArray(a)){const[,t]=a.find((t=>{let[e,n]=t
return e===B.bU}))
a=[...a,["sentry-trace",n.toTraceparent()],[B.bU,(0,B.J8)(e,t)]]}else a={...a,"sentry-trace":n.toTraceparent(),baggage:(0,B.J8)(e,a.baggage)}
else a={"sentry-trace":n.toTraceparent(),baggage:(0,B.J8)(e)}
return a}(r,a.getBaggage(),s,o)}}}(t,o,c)})),n&&(0,et.o)("xhr",(t=>{!function(t,e,n){if(!(!(0,U.zu)()||t.xhr&&t.xhr.__sentry_own_request__)&&t.xhr&&t.xhr.__sentry_xhr__&&e(t.xhr.__sentry_xhr__.url)){var i=t.xhr.__sentry_xhr__
if(t.endTimestamp){var a=t.xhr.__sentry_xhr_span_id__
if(!a)return;(r=n[a])&&(r.setHttpStatus(i.status_code),r.finish(),delete n[a])}else{var s=(0,U.x1)()
...
var o=t.xhr.getRequestHeader&&t.xhr.getRequestHeader(B.bU)
t.xhr.setRequestHeader(B.bU,(0,B.J8)(s.getBaggage(),o))}catch(t){}}}}}(t,o,c)}))}var at=(0,x.R)(),st="BrowserTracing",rt={idleTimeout:G.nT,finalTimeout:G.mg,markBackgroundTransactions:!0,routingInstrumentation:function(t){let e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
...
var e=z()
e&&I.Z1&&(e.mark&&F.performance.mark("sentry-tracing-init"),Z(),Q(t),K())}(n&&n._reportAllChanges),(0,s.x)([this,"access",t=>t.options,"access",t=>t._experiments,"optionalAccess",t=>t.enableLongTask])&&w("longtask",(t=>{var e=(0,U.x1)()
if(e){var n=(0,U.XL)(I.Z1+t.startTime),i=(0,U.XL)(t.duration)
...
const{location:p}=(0,x.R)()
var l=(0,a.lb)(d,_,n,i,!0,{location:p})
return l.registerBeforeFinishCallback((t=>{(function(t){var e=z()
if(!e||!F.performance.getEntries||!I.Z1)return;("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Tracing] Adding & adjusting spans using Performance API")
var n=(0,U.XL)(I.Z1),i=e.getEntries()
let a,s
if(i.slice(X).forEach((e=>{var i=(0,U.XL)(e.startTime),o=(0,U.XL)(e.duration)
if(!("navigation"===t.op&&n+i<t.startTimestamp))switch(e.entryType){case"navigation":!function(t,e,n){["unloadEvent","redirect","domContentLoadedEvent","loadEvent","connect"].forEach((i=>{V(t,e,i,n)})),V(t,e,"secureConnection",n,"TLS/SSL","connectEnd"),V(t,e,"fetch",n,"cache","domainLookupStart"),V(t,e,"domainLookup",n,"DNS"),function(t,e,n){H(t,{op:"browser",description:"request",startTimestamp:n+(0,U.XL)(e.requestStart),endTimestamp:n+(0,U.XL)(e.responseEnd)}),H(t,{op:"browser",description:"response",startTimestamp:n+(0,U.XL)(e.responseStart),endTimestamp:n+(0,U.XL)(e.responseEnd)})}(t,e,n)}(t,e,n),a=n+(0,U.XL)(e.responseStart),s=n+(0,U.XL)(e.requestStart)
break
...
break
case"resource":var d=e.name.replace(F.location.origin,"")
...
var o=s+i
H(t,{description:n,endTimestamp:o+a,op:e.initiatorType?`resource.${e.initiatorType}`:"resource",startTimestamp:o,data:r})}}(t,e,d,i,o,n)}})),X=Math.max(i.length-1,0),function(t){var e=F.navigator
if(e){var n=e.connection
n&&(n.effectiveType&&t.setTag("effectiveConnectionType",n.effectiveType),n.type&&t.setTag("connectionType",n.type),P(n.rtt)&&(W["connection.rtt"]={value:n.rtt,unit:"millisecond"}),P(n.downlink)&&(W["connection.downlink"]={value:n.downlink,unit:""})),P(e.deviceMemory)&&t.setTag("deviceMemory",`${e.deviceMemory} GB`),P(e.hardwareConcurrency)&&t.setTag("hardwareConcurrency",String(e.hardwareConcurrency))}}(t),"pageload"===t.op){"number"==typeof a&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding TTFB"),W.ttfb={value:1e3*(a-t.startTimestamp),unit:"millisecond"},"number"==typeof s&&s<=a&&(W["ttfb.requestTime"]={value:1e3*(a-s),unit:"millisecond"})),["fcp","fp","lcp"].forEach((e=>{if(W[e]&&!(n>=t.startTimestamp)){var i=W[e].value,a=n+(0,U.XL)(i),s=Math.abs(1e3*(a-t.startTimestamp)),o=s-i;("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Measurements] Normalized ${e} from ${i} to ${s} (${o})`),W[e].value=s}}))
var o=W["mark.fid"]
o&&W.fid&&(H(t,{description:"first input delay",endTimestamp:o.value+(0,U.XL)(W.fid.value),op:"web.vitals",startTimestamp:o.value}),delete W["mark.fid"]),"fcp"in W||delete W.cls,Object.keys(W).forEach((e=>{t.setMeasurement(e,W[e].value,W[e].unit)})),function(t){j&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding LCP Data"),j.element&&t.setTag("lcp.element",(0,k.Rt)(j.element)),j.id&&t.setTag("lcp.id",j.id),j.url&&t.setTag("lcp.url",j.url.trim().slice(0,200)),t.setTag("lcp.size",j.size)),J&&J.sources&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS Data"),J.sources.forEach(((e,n)=>t.setTag(`cls.source.${n+1}`,(0,k.Rt)(e.node)))))}(t)}j=void 0,J=void 0,W={}})(t),t.setTag("sentry_reportAllChanges",Boolean(this.options._metricOptions&&this.options._metricOptions._reportAllChanges))})),l}}function ct(t){var e=(0,k.qT)(`meta[name=${t}]`)
...
//# sourceMappingURL=chunk.174.2edaa0869bfc2d88cf90.map